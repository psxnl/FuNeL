...
class windowingILAS : public windowing{
	...
	void reorderInstancesDOB();
	void reorderInstancesDOB_approx();
	double nominalAttributeValidation(int pClass,int attr,JVector<instance *>&sample);
	double realValuedAttributeValidation(int pClass,int attr,JVector<instance *>&sample);
